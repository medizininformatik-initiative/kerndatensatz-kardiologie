...
- Vorschauversion: [2027.0.0-ballot](https://simplifier.net/mii-erweiterungsmodul-kardiologie/~releases) </br>  <!--[yyyy-x.x.x](https://simplifier.net/MII-Erweiterungsmodul-Kardiologie/~packages)-->
