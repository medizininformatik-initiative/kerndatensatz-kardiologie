# MII EXA Kardio Höhergradiges Vitium Nein - MII IG Modul Kardio DE v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII EXA Kardio Höhergradiges Vitium Nein**

## Beispiel Observation: MII EXA Kardio Höhergradiges Vitium Nein
...
```json
{
  ...
  "id" : "mii-exa-kardio-hoehergradiges-vitium-nein",
  "meta" : {
  ...
  "code" : {
    ...
    "text" : "Höhergradiges Vitium primärer Genese"
  },
  "subject" : {
