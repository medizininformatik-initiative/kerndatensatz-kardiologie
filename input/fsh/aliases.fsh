...
Alias: $ath-ereignis-with-version         = MII_CS_Kardio_Atherosklerotisches_Ereignis|2027.0.0-ballot.rc1
Alias: $mrs-with-version                  = MII_CS_Kardio_Modifizierte_Rankin_Skala|2027.0.0-ballot.rc1
