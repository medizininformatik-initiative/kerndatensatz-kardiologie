...
Alias: $example-loinc       = http://loinc.org|2.81
Alias: $example-sct         = http://snomed.info/sct|http://snomed.info/sct/900000000000207008/version/20250701
Alias: $example-ucum        = http://unitsofmeasure.org|2.2  //2024.7.1 //2.2
...
Alias: $example-mRS         = https://www.medizininformatik-initiative.de/fhir/ext/modul-kardio/ValueSet/mii-cs-kardio-modifizierte-rankin-skala|$kds_kardio_version
Alias: $example-ath-ereignis = https://www.medizininformatik-initiative.de/fhir/ext/modul-kardio/CodeSystem/mii-cs-kardio-atherosklerotisches-ereignis|$kds_kardio_version
Alias: $example-acribis-follow-up = https://www.medizininformatik-initiative.de/fhir/ext/modul-kardio/CodeSystem/mii-cs-follow-up|$kds_kardio_version
...
Alias: $example-v3-ActCode  = http://terminology.hl7.org/CodeSystem/v3-ActCode|3.1.0
Alias: $example-condition-clinical = http://terminology.hl7.org/CodeSystem/condition-clinical|3.0.0
Alias: $example-condition-ver-status = http://terminology.hl7.org/CodeSystem/condition-ver-status|2.0.1
Alias: $example-observation-category = http://terminology.hl7.org/CodeSystem/observation-category|2.0.0
