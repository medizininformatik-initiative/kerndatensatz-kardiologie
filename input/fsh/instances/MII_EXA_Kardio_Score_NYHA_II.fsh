...
* status = #final
* code.coding[sct] = $example-sct#762994006 "New York Heart Association Classification class"
* code.coding[loinc] = $example-loinc#93124-6 "New York Heart Association Functional Classification panel"
