Instance: MII-QN-Kardio-ExampleQN
...
* insert Version
* name = "MII_QN_Kardio_ExampleQN"                                       // Technischer Name (PascalCase empfohlen)
* title = "ExampleQN"                                                    // Titel zur Anzeige
* status = #draft                                                        // #draft | #active | #retired | #unknown
* experimental = true                                                    // true = fuer experimentellen Gebrauch, sonst false
* date = "2025-06-18"  
* insert Instance_Publisher
* description = "Beispiel / Test der Implementation eines Fragebogen als FHIR R4 Questionnaire." // Beschreibung
